...
base='http://stuartsbuild.x10host.com/'
ADDON=xbmcaddon.Addon(id='plugin.video.spartan')
...
def CATEGORIES():
    link = OPEN_URL('https://archive.org/download/wizard_test_20151202_2207/wizard_test.txt').replace('\n','').replace('\r','')
