...
# *
# *     Modified for RayW1986 Repository (04/2015 onwards)
# *     by Ray Wilson [RayW1986]
# *
...
if ( __name__ == "__main__" ):
    ...
    try:
        ...
        for x in filesinrootdir:
            if re.search("plugin|context|script|service|skin|repository" , x) and not re.search('.zip',x):
                zipfilename = x + '.zip'
